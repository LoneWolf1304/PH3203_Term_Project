...
\begin{titlepage}
    ...
    \begin{center}
        {\sffamily\bfseries
        \Huge\textbf{\textcolor{titleblue}{Classification of Entanglement using Knots}}\\[0.2cm] 
        \Large \textcolor{blue!60!black}{A Topological Approach to Quantum States}\\[1.0cm]
       ...
       \textbf{ Depart of Physical Sciences}\\
        ...
        \begin{figure}[H]
            \centering
            \includesvg[scale=0.2]{IISER-Kolkata-logo-vector-01.svg}
        \end{figure}
       \end{center}
\end{titlepage}
