...
\begin{document}
	...
	\begin{frame}{\textbf{Three Qubit System}: 3\textsuperscript{1} class}
		...
		\begin{minipage}{0.35\textwidth}
			%\input{pics/borromean.tex}  % Make sure this file exists
			\scalebox{0.6}{\input{pics/borromean_cut.tex}}
			\begin{itemize}
	...
	\begin{frame}{\textbf{Three Qubit System}: 3\textsuperscript{2} class}
		...
		\begin{minipage}{0.35\textwidth}
			%\input{pics/borromean.tex}  % Make sure this file exists
			\begin{figure}
			\scalebox{0.4}{\input{pics/3_2.tex}}\end{figure}
			\begin{itemize}
	...
	\begin{frame}{\textbf{Three Qubit System}: 3\textsuperscript{2} class}
		...
		\begin{minipage}{0.35\textwidth}
			%\input{pics/borromean.tex}  % Make sure this file exists
			\begin{figure}
			\scalebox{0.4}{\input{pics/3_2_cut1.tex}}\end{figure}
			\begin{itemize}
	...
	\begin{frame}{\textbf{Three Qubit System}: 3\textsuperscript{2} class}
		...
		\begin{minipage}{0.35\textwidth}
			%\input{pics/borromean.tex}  % Make sure this file exists
			\begin{figure}
			\scalebox{0.4}{\input{pics/3_2_cut2.tex}}\end{figure}
			\begin{itemize}
